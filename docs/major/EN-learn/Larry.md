...
<table>
  ...
  <tr>
    ...
    <td>✗</td>
    <td>名词 / 形容词 / 副词</td>
    <td rowspan="3">保留了动词的特点，可以有时态变化，且可以携带自己的宾语(vt)，状语等等</td>
  </tr>
  <tr>
    <td>动名词</td>
    <td>✗</td>
...
!!!  
    非谓语动词在句子中已经失去了作为动词的词性，要当作名词（主、宾、表、状）、形容词（定、表、补）、或者副词（状）来对待，但其本身保留了动词的特征，可以有时态变化，且可以携带自己的宾语、状语等。
