...
!!! info "税后收入计算指南"
    ...
    === "咸鱼暄的个税计算器"
        ...
        可以通过[咸鱼暄的个税计算器](https://xuan-insr.github.io/magic_tools/personal_income_tax/?slr=240000&srv=0&roy=0&frn=0&otf=0&ded=60000&bpi=19200&bmi=4800&uei=1200&hfd=16800&ced=0&coed=0&sim=0&hli=0&hrt=0&sre=0&inf=0&ann=0&chi=0&tdp=0&alt=0&pep=0&oth=0&don=0&abn=0&adn=0){:target=_blank}进行计算并验证，这里可以考虑"全年一次性奖金"对应的个税，并且还有其他专项附加扣除项等等。🥰
